...
def show_login():
    ...
    # , gh_auth_link=(
    #     '%s?scope=%s&client_id=%s&state=%s' % (GH_AUTHORIZATION_BASE_URL, GH_SCOPE, GH_CLIENT_ID, state)))
...
#         'email']  # to get the email from google, make sure login page has data-scope="openid email"
